...
model = MaskPropagation('/volume/willy-dev/sota/3DAnnotatePropWizard/weights/sam_vit_b_01ec64.pth', '/volume/willy-dev/sota/3DAnnotatePropWizard/yaml/eval_config.yaml')

cases_folders = sorted(glob(os.path.join("/volume/open-dataset-ssd/ai99/gen_data/meningioma", "*")))
